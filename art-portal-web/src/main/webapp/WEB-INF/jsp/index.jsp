		...
		<div class="banner">		
			<div class="bd">
				<ul>
					...
					<li style="background:url(upload/2.jpg) #15181e center 0 no-repeat;"><a href="#"></a></li>
					<li style="background:url(upload/3.jpg) #0b0b0b center 0 no-repeat;"><a href="#"></a></li>
					<li style="background:url(upload/4.jpg) #000000 center 0 no-repeat;"><a href="#"></a></li>
					<li style="background:url(upload/5.jpg) #04304b center 0 no-repeat;"><a href="#"></a></li>
				</ul>
			</div>
